...
#teachers
User.create(first_name: "John", last_name: "Kimble", email:"o1@e.e", password:"qwerty") #1
User.create(first_name: "Mr.", last_name: "Garrison", email:"o2@e.e", password:"qwerty")
User.create(first_name: "William", last_name: "Forrester", email:"o3@e.e", password:"qwerty")
User.create(first_name: "Ms.", last_name: "Krabbapel", email:"o4@e.e", password:"qwerty") #4
