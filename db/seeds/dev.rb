#teachers
@ope = User.create(first_name: "John", last_name: "Kimble", email:"o1@e.e", password:"qwerty") #1
@ope2 = User.create(first_name: "Mr.", last_name: "Garrison", email:"o2@e.e", password:"qwerty")
@ope3 = User.create(first_name: "William", last_name: "Forrester", email:"o3@e.e", password:"qwerty")
